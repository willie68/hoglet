...
public class FilterBuilder implements Cloneable, Serializable {
   ...
   *          expected elements in the filter
   ...
   *
   * @param countingBits
   *          Number of counting bits used by the counting Bloom filter
   * @return the modified FilterBuilder (fluent interface)
   */
   ...
   *
   * @param gracePeriodInMillis
   *          The grace period to set, in milliseconds.
   * @return the modified FilterBuilder (fluent interface)
   */
   ...
   *
   * @param gracePeriod
   *          The grace period to set, in the provided time unit.
   * @param unit
   *          The time unit in which the grace period is given.
   * @return the modified FilterBuilder (fluent interface)
   */
   ...
   *
   * @param unit
   *          The {@link TimeUnit} to which the Grace Period is converted
   ...
   *
   * @param cleanupIntervalInMillis
   *          The cleanup interval to set, in milliseconds.
   * @return the modified FilterBuilder (fluent interface)
   */
   ...
   *          The cleanup interval to set, in the provided time unit.
   * @param unit
   *          The time unit in which the cleanup interval is given.
   * @return the modified FilterBuilder (fluent interface)
   */
   ...
   *
   * @param unit
   *          The {@link TimeUnit} to which the cleanup interval is converted
   ...
   *
   * @param <T>
   *          the type of element contained in the Bloom filter.
   ...
   *
   * @param <T>
   *          the type of element contained in the Counting Bloom filter.
